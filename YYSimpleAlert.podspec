...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/flip.flop/YYSimpleAlert'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'flip.flop' => 'flip.flop@kakaocorp.com' }
  s.source           = { :git => 'https://github.com/flip.flop/YYSimpleAlert.git', :tag => s.version.to_s }
